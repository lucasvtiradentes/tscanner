...
<details>
<summary>Ways to use TScanner</summary>
<br />
...
If you share the vision of improving and simplifying code quality in codebases for both humans and AI agentic tools, check out these complementary projects:

- [**Knip**](https://github.com/webpro-nl/knip) - Find unused files, dependencies and exports in JavaScript and TypeScript projects. Knip builds a comprehensive module graph to identify dead code, unused dependencies, and exports that ESLint misses. Works with 100+ frameworks and tools.

- [**Biome**](https://github.com/biomejs/biome) - High-performance Rust-based linter and formatter for web projects. Blazing fast alternative to ESLint + Prettier with a focus on developer experience and sub-second execution times.

> **How they complement TScanner:** While TScanner enforces custom project patterns and conventions, Knip removes dead code and unused dependencies, and Biome handles formatting and standard linting. Together, they create a comprehensive code quality toolkit optimized for AI-assisted development workflows.
