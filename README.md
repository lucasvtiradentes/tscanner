...
If you think we need to improve and simplify the code quality of our codebases both for humans and AI agentic tools, you may also want to check out these tools:

- [Knip](https://github.com/webpro-nl/knip) - Find unused files, dependencies and exports in JavaScript and TypeScript projects
- [Biome](https://github.com/biomejs/biome) - High-performance Rust-based linter and formatter for web projects
